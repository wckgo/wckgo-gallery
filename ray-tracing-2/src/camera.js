import { degrees_to_radians, cross, Vec3, random_in_unit_disk, add, random } from "./util";
import Ray from "./ray";

export default class Camera {
  constructor(lookfrom, lookat, vup, vfov, aspect_ratio, aperture, focus_dist, t0 = 0, t1 = 0) {
  ...
  get_ray(s, t) {
    ...
    const dir = this.lower_left_corner.clone()
      ...
      .sub(this.origin)
      .sub(offset);
    return new Ray(add(this.origin, offset), dir, random(this.t0, this.t1));
  }
